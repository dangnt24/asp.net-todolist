                ...
                <div class="mb-4 rounded sw__item" style="width: 100%; max-width: 320px; height: 300px; background-color: ${bgColor};">
                    <form method="post" action="/StickyWall/Add">
                        ...
                        <div class="p-3 pb-5 position-relative sw__item--content">
                            ...
                            <button type="submit" class="position-absolute sw__cancel--btn" style="top: 2.5rem; right: 0.7rem; font-size: 24px; box-shadow: none; border: 0; padding: 0; background: none;"><i class="fas fa-xmark fw-bold"></i></button>
                            <img class="position-absolute sw__changeColor--btn" style="width: 22px; height: 22px; top: 4.6rem; right: 0.5rem;" src="/Images/icon-change-color.jpg" alt="changeColor" />
